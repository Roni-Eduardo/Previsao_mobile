...
class _FiltroPageState extends State<FiltroPage>{
  final camposParaOrdenacao= {
    Previsao.campo_id: 'Cidade', Previsao.campo_descricao: 'Estado'
  };
  ...
  void _carregarSharedPreferences() async {
    ...
    setState(() {
      _campoOrdenacao = prefs.getString(FiltroPage.CHAVE_CAMPO_ORDENACAO) ?? Previsao.campo_id;
    ...
    return ListView(
      children: [
        const Padding(
          ...
          child: Text('Campos para Localização'),
        ),
